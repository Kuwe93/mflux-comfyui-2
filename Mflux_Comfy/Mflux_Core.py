...
def generate_image(prompt, model, seed, width, height, steps, guidance,
    ...
    # img2img params – Parameternamen unterscheiden sich je nach Modellfamilie:
    # flux1/flux2/fibo: init_image_path + init_image_strength
    # zimage (base+turbo): image_path + image_strength  (andere Konvention in ZImage.generate_image)
    if image_path:
        if family == "zimage":
